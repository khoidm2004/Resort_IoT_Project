  ...
  return (
    <div className="home">
      ...
      <div className="db-box-list">
        <DashboardBox room="A" humid={latesthumid} temp={latesttemp} />
        <DashboardBox room="B" humid={latesthumid} temp={latesttemp} />
        <DashboardBox room="C" humid={latesthumid} temp={latesttemp} />
        <DashboardBox room="D" humid={latesthumid} temp={latesttemp} />
      </div>
